...
function showResults(userOption) {
    ...
    Gratulálok!`;
		...
		winnerMsgElement.innerText = ` Ezennel a Skynet győzedelmeskedett az ember felett,
     szeretett világunk ismét közelebb került a pusztuláshoz,
      s a 100%-ban digitális társadalom beköszöntéséhez.`;
		resetGameBtn.style.display = "block";
		optionsContainer.style.display = "none";
	}
